...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Meu Blog web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 6M2zSLS9U3gY0KNxHfHbeDKlopUvJUSAX3ziwoJRGeU
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("meu_blog.log", "w"))
  #
  #
end
